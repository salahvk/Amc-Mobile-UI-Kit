...
class AMCDropdown extends StatefulWidget {
  ...
  @override
  AMCDropdownState createState() => AMCDropdownState();
}

class AMCDropdownState extends State<AMCDropdown> {
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return ListTile(
                        title: Text(
                          item,
                          style:
                              widget.textStyle ?? AMCTextStyle.paragraph2.style,
                        ),
                        onTap: () {
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          ...
          suffixIcon: Padding(
            ...
            child:
                AppIcon('$kAssetsIcons/ic_down_arrow_text_field.svg', size: 8),
          ),
        ),
      ),
    );
