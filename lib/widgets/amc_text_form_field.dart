...
class AMCTextFormField extends StatelessWidget {
      ...
      children: [
        if (labelText != null && labelText!.isNotEmpty)
          Padding(
            ...
            child: Text(
              labelText!,
              style: labelStyle ?? AMCTextStyle.paragraph1.style,
            ),
          ),
        TextFormField(
          ...
          maxLines: maxLines,
          style: textStyle ?? AMCTextStyle.paragraph2.style,
          validator: validator,
          onChanged: onChanged,
          decoration: InputDecoration(
            hintText: hintText,
            hintStyle: hintStyle ??
                AMCTextStyle.paragraph2.style.copyWith(
