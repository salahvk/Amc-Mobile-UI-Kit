...
import 'package:amc_ui_kit/animations/amc_toast.dart';
...
class Toast {
  ...
  static Future success(
    ...
    return _buildCustomToast(
      AMCToast.success(text: msg),
      align: align,
    );
  }
  ...
  static Future error(String msg, {Alignment align = const Alignment(0, 0.8)}) {
    return _buildCustomToast(
      AMCToast.error(text: msg),
      align: align,
    );
  }

  static Future _buildCustomToast(
    AMCToast dzToastWidget, {
    Alignment align = const Alignment(0, 0.8),
  }) {
    final Duration toastDuration =
        Duration(seconds: _getToastDuration(dzToastWidget.text));
    ...
    BotToast.showCustomText(
      ...
      toastBuilder: (_) => IntrinsicHeight(
        child: Padding(
